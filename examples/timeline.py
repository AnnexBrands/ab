...
def increment_status_example(api: ABConnectAPI) -> None:
    ...
    # Returns ServiceBaseResponse.
    request_body = load_request_json("IncrementStatusRequest.json")
...
if __name__ == "__main__":
    ...
    # AB_RUN_MUTATIONS=1 is set (they mutate staging).
    if mutations_enabled():
        increment_status_example(api)
        undo_increment_status_example(api)
    else:
        print(
            "# api.jobs.timeline.increment_status / undo_increment_status skipped"
