...
runner.add(
    "insurance",
    lambda api, data=None: api.reports.insurance(**(data or {})),
...
runner.add(
    "sales",
    lambda api, data=None: api.reports.sales(**(data or {})),
...
runner.add(
    "sales_summary",
    lambda api, data=None: api.reports.sales_summary(**(data or {})),
...
runner.add(
    "sales_drilldown",
    lambda api, data=None: api.reports.sales_drilldown(**(data or {})),
...
runner.add(
    ...
    lambda api, data=None: api.reports.top_revenue_customers(**(data or {})),
    request_model="Web2LeadRevenueFilter",
    request_fixture_file="Web2LeadRevenueFilter.json",
    response_model="List[RevenueCustomer]",
)
...
runner.add(
    ...
    lambda api, data=None: api.reports.top_revenue_sales_reps(**(data or {})),
    request_model="Web2LeadRevenueFilter",
    request_fixture_file="Web2LeadRevenueFilter.json",
    response_model="List[RevenueCustomer]",
)
...
runner.add(
    "referred_by",
    lambda api, data=None: api.reports.referred_by(**(data or {})),
...
runner.add(
    "web2lead",
    lambda api, data=None: api.reports.web2lead(**(data or {})),
