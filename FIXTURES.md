...
- **Total endpoints**: 231
- **Complete (all gates pass)**: 27
- **G1 Model Fidelity**: 38/231 pass
...
| /contacts/{contactId}/editdetails | GET | — | ContactDetailedInfo | FAIL | PASS | PASS | PASS | PASS | PASS | incomplete | HTTP 500 on staging — was previously captured but now fails |
