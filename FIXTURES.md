...
| Endpoint Path | Method | Model Name | Date | Source |
|---------------|--------|------------|------|--------|
| /companies/{id} | GET | CompanySimple | 2026-02-13 | staging |
| /companies/{id}/fulldetails | GET | CompanyDetails | 2026-02-13 | staging |
| /companies/availableByCurrentUser | GET | SearchCompanyResponse | 2026-02-13 | staging |
| /contacts/user | GET | ContactSimple | 2026-02-13 | staging |
| /contacts/{id}/editdetails | GET | ContactDetailedInfo | 2026-02-13 | staging |
...
| /lookup/contacttypes | GET | ContactTypeEntity | 2026-02-13 | staging |
| /lookup/countries | GET | CountryCodeDto | 2026-02-13 | staging |
...
| /users/roles | GET | UserRole | 2026-02-13 | staging |
...
| Endpoint Path | Method | Model Name | Capture Instructions | Blocker |
|---------------|--------|------------|---------------------|---------|
...
| /job/{id}/shipment/accessorials | GET | Accessorial | `api.shipments.get_accessorials(job_id)` | Needs job with shipment |
...
| /shipment/accessorials | GET | GlobalAccessorial | `api.shipments.get_global_accessorials()` | May need specific carrier config |
