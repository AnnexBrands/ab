...
_CREATE = Route("POST", "/Catalog", request_model="AddCatalogRequest", response_model="CatalogWithSellersDto", api_surface="catalog")
...
_UPDATE = Route("PUT", "/Catalog/{id}", request_model="UpdateCatalogRequest", response_model="CatalogWithSellersDto", api_surface="catalog")
