...
class ServiceBaseResponse(ResponseModel):
    ...
    confirm_required: Optional[bool] = Field(None, alias="confirmRequired", description="Whether user confirmation is needed")
    ...
    fed_ex_express_freight_detail_required: Optional[bool] = Field(
        None, alias="fedExExpressFreightDetailRequired", description="Whether FedEx Express freight details are required"
    )
